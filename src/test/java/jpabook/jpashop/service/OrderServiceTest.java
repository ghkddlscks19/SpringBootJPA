...
class OrderServiceTest {
    ...
    void 상품주문() throws Exception{
        ...
        Assertions.assertEquals(8, book.getStockQuantity(), "주문 수량마늠 재고가 줄어야 한다.");
    ...
    void 상품주문_재고수량초과() throws Exception{
        ...
        //then
        NotEnoughStockException notEnoughStockException = Assertions.assertThrows(NotEnoughStockException.class, () -> orderService.order(member.getId(), item.getId(), orderCount));
        Assertions.assertEquals("need more stock", notEnoughStockException.getMessage());
    ...
    void 주문취소() throws Exception{
        ...
        Assertions.assertEquals(10, item.getStockQuantity(), "주문이 취소된 상품은 그만큼 재고가 증가해야한다..");
